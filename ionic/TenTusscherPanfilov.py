...
class TenTusscherPanfilov:
    ...
    def differentiate(self, V):
        ...
        Eca = ((0.5*RTONF)*(log((self.Cao/self.Cai))))
        Ek = (RTONF*(log((self.Ko/self.Ki))))
        Eks = (RTONF*(log(((self.Ko+(self.pKNa*self.Nao))/(self.Ki+(self.pKNa*self.Nai))))))
        Ena = (RTONF*(log((self.Nao/self.Nai))))
