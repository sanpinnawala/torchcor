...
data_dir = "/data/home/acw554/Data/ventricle"
...
simulator.load_mesh(path=data_dir)
...
simulator.add_stimulus(f"{data_dir}/LV_sf.vtx", start=0.0, duration=1.0, intensity=100)
simulator.add_stimulus(f"{data_dir}/LV_pf.vtx", start=0.0, duration=1.0, intensity=100)
simulator.add_stimulus(f"{data_dir}/LV_af.vtx", start=0.0, duration=1.0, intensity=100)
simulator.add_stimulus(f"{data_dir}/RV_sf.vtx", start=5.0, duration=1.0, intensity=100)
simulator.add_stimulus(f"{data_dir}/RV_mod.vtx", start=5.0, duration=1.0, intensity=100)
