...
class ScalarGCN(nn.Module):
    def __init__(self, hidden_channels=64, dropout=0.2):
        ...
        # GraphSAGE layers
        self.conv1 = GATConv(4, hidden_channels, aggr='mean')  # Input features = 1 (scalar)
        self.bn1 = BatchNorm(hidden_channels)

        self.conv2 = GATConv(hidden_channels, hidden_channels, aggr='mean')
